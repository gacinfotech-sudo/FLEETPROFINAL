...
// P0-1 FIX — see salesConfigModels.test.ts's identical fix for the full
// incident report. Always use a dedicated, uniquely-named throwaway
// database, unconditionally overriding any inherited MONGODB_URI.
process.env.MONGODB_URI = `mongodb://127.0.0.1:27017/fleetpro_test_sales_config_http_${randomUUID().slice(0, 8)}`;
