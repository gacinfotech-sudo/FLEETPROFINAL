...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // w-[calc(100%-2rem)] instead of w-full: leaves a safe 1rem gutter
        // on each side at narrow viewports instead of touching both edges.
        ...
        // (confirmed live: every element in the Booking Details dialog
