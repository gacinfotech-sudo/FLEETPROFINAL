...
export default function AuditLogPage() {
  ...
  return (
    <div className="space-y-6 p-6" data-testid="page-audit-log">
      <div>
        <h1 className="flex items-center gap-2 text-2xl font-bold">
          <ScrollText className="h-6 w-6" aria-hidden="true" /> Platform Audit Log
        </h1>
        <p className="text-sm text-muted-foreground">
          Immutable record of Root login, tenant view, PII unmask, Support Access, break-glass, and configuration
          change events.
        </p>
      </div>
